## A Raspberry Pi smart home hub using Node.js, Express, and resin.io.

This is a simple skeleton Express server project that works on any of the [resin.io][resin-link] supported devices.

This app serves a user interface on port `:80` of your resin.io device.
...
```
$ git clone git@github.com:brianteachman/b3hc.git
```
...
Then in your browser you should be able to open the device URL and see the user interface".
